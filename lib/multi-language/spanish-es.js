...
methodCode2: 'كيف تريد الربط؟',
methodCode3: 'خيارات',
methodCode4: 'عن طريق رمز QR',
methodCode5: 'عن طريق الكود',
methodCode6: 'أدخل الرقم',
methodCode7: 'خيار الرابط',
methodCode8: 'نصيحة',
methodCode9: 'إذا كنت تستخدم تيرمكس أو ريبلايت أو لينكس أو ويندوز',
methodCode10: 'استخدم هذه الاوامر للتنفيذ المباشر',
methodCode11: (chalk) => `غير مسموح بأرقام غير ${chalk.bold.greenBright("1")} أو ${chalk.bold.greenBright("2")}، ولا أحرف أو رموز خاصة.\n${chalk.bold.yellowBright("نصيحة: انسخ رقم الخيار والصقه في وحدة التحكم.")}`,
methodCode12: 'ابدأ باستخدام رمز QR',
methodCode13: 'ابدأ بإستخدام الكود المكون من 8 ارقام',
methodCode14: 'بدء التشغيل الافتراضي مع الخيارات',
phNumber2: (chalk) => `الرجاء إدخال رقم WhatsApp.\n${chalk.bold.yellowBright("نصيحة: انسخ رقم WhatsApp والصقه في وحدة التحكم.")}\n${chalk.bold.yellowBright("مثال: +201224563219")}\n${chalk.bold.magentaBright('---> ')}`,
pairingCode: 'كود الربط:',
mCodigoQR: `\n✅ امسح رمز QR ينتهي في 45 ثانية`,
mConexion: `\n❒⸺⸺⸺⸺【• متصل •】⸺⸺⸺⸺❒\n│\n│ 🟢 تم الاتصال بـ WhatsApp بنجاح.\n│\n❒⸺⸺⸺⸺【• متصل •】⸺⸺⸺⸺❒`,
mConexionOFF: "\n❌𒌍 تم استبدال الاتصال، يرجى الانتظار لحظة وسأعيد التشغيل...\nإذا ظهر خطأ، ابدأ مرة أخرى باستخدام: npm start"", 
